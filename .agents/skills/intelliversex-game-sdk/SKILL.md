...
> **Discovery path:** `.agents/skills/intelliversex-game-sdk/SKILL.md` (project or `~/.agents/skills/`). Canonical twin: [`skills/intelliversex-game-sdk/SKILL.md`](../../../skills/intelliversex-game-sdk/SKILL.md).
...
Smithery server metadata lives in the repo root [`smithery.yaml`](../../../smithery.yaml) (`name: intelliversex-game-sdk`). The hosted MCP origin must serve Smithery’s static [`server-card.json`](../../../.well-known/mcp/server-card.json) at `/.well-known/mcp/server-card.json` for registry publish; see [`docs/platforms/mcp-smithery-publish.md`](../../../docs/platforms/mcp-smithery-publish.md).
