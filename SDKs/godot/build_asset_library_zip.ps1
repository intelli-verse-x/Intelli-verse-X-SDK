...
Write-Host "1. Create a GitHub Release (e.g. tag godot-v$Version) at https://github.com/Intelli-verse-X/Intelli-verse-X-SDK/releases/new"
...
Write-Host "   It will look like: https://github.com/Intelli-verse-X/Intelli-verse-X-SDK/releases/download/godot-v$Version/$ZipName"
