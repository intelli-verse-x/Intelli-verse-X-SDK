...
// ---------------------------------------------------------------------------
// Discord Social SDK — Rich Presence, Friends, Lobby, Voice & Invites (Web3)
// ---------------------------------------------------------------------------
...
/**
 * Discord Social SDK integration for IntelliVerseX Web3 SDK.
 *
...
export class IVXDiscordSocial {
  ...
  private log(message: string): void {
    if (this._config?.enableDebugLogs) {
      console.log(`[IntelliVerseX Web3:Discord] ${message}`);
    }
  }
}
