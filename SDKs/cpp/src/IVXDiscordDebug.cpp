...
void IVXDiscordDebug::emitLog(IVXDiscordLogLevel level, const std::string& message,
    ...
    if (_history.size() > MAX_HISTORY) {
        _history.erase(_history.begin(), _history.begin() + static_cast<std::ptrdiff_t>(_history.size() - MAX_HISTORY));
    }
