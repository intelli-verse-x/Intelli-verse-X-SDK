...
public:
    ...
    /// Invoked by the native bridge when a log line is produced.
    void emitLog(IVXDiscordLogLevel level, const std::string& message,
                 const std::string& source = "discord");
