...
- [ ] At least one Git tag exists (e.g. `v6.0.0`) for the build
...
- **Version tags:** OpenUPM builds from Git tags. Use semver (e.g. `v6.0.0`). Create tags via GitHub Releases or: `git tag v6.0.0 && git push origin v6.0.0`
